...
A beginner developer can use this template as a starting point for creating other REACT projects that are properly set up with CSS and have ESLint configured.
